...
### Добавлено
- **Сообщение об ошибке превышения квоты**: Теперь при возникновении проблем с квотой отображается сообщение об ошибке «Quota exceeded! Change model!».
### Изменено
- Модель Gemini Pro исключена из списка поддерживаемых из-за частых проблем с лимитами квоты.
- Удалены устаревшие модели, которые больше не поддерживаются API.

## [0.7.0] - 2025-08-27

### Добавлено

- **Выбор модели Gemini в WebView**: Добавлено выпадающее меню на панели WebView, позволяющее пользователям напрямую выбирать модель Gemini для анализа ошибок. Это дает возможность гибко выбирать нужную модель в зависимости от требований к скорости, стоимости или производительности.
- **Поддержка новых моделей**: Добавлена поддержка следующих моделей Gemini:
  - `gemini-2.0-flash`
